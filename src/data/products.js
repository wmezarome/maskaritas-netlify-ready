...
export const products = [
  ...
  // ---------------------------------------------------------------
  // Productos reales — primer lote subido por William. Fotos reales,
  // precio confirmado por WhatsApp/chat ($250 c/u). Cantidad en
  // sizeInventory es un valor de arranque — ajústalo en cuanto
  // confirmes el stock real de cada pieza.
  // ---------------------------------------------------------------
  {
    id: 'prod-001',
    slug: 'diadema-medusa-serpientes',
    sku: 'MSK-2026-101',
    name: 'Diadema Medusa de Serpientes',
    shortName: 'Diadema Medusa',
    category: 'accesorios',
    subcategory: 'diademas',
    collection: 'halloween',
    audience: 'adultos',
    description: 'Diadema estilo Medusa con serpientes doradas entrelazadas sobre base negra. Pieza statement para completar un look de temporada.',
    contents: ['1 diadema'],
    price: 250,
    compareAtPrice: null,
    sizes: ['Única'],
    sizeInventory: { Única: 5 },
    colors: ['Dorado / Negro'],
    images: ['/images/products/diadema-medusa-serpientes-01.jpg'],
    featured: true,
    newArrival: true,
    bestSeller: false,
    lowStock: false,
    available: true,
    tags: ['medusa', 'serpientes', 'diadema', 'halloween', 'accesorio'],
    season: 'halloween',
    seoTitle: 'Diadema Medusa de Serpientes — Accesorios Halloween Mérida | Maskaritas',
    seoDescription: 'Diadema Medusa con serpientes doradas, pieza statement para Halloween. Entregas en Mérida, Yucatán.',
  },
  {
    id: 'prod-002',
    slug: 'diadema-cuernos-demonio',
    sku: 'MSK-2026-102',
    name: 'Diadema Cuernos de Demonio',
    shortName: 'Diadema Cuernos',
    category: 'accesorios',
    subcategory: 'diademas',
    collection: 'halloween',
    audience: 'adultos',
    description: 'Diadema con cuernos texturizados y base ornamentada en rojo y plata. Ideal para disfraces de demonio, fauno o criatura de fantasía.',
    contents: ['1 diadema'],
    price: 250,
    compareAtPrice: null,
    sizes: ['Única'],
    sizeInventory: { Única: 5 },
    colors: ['Café / Rojo'],
    images: ['/images/products/diadema-cuernos-demonio-01.jpg'],
    featured: false,
    newArrival: true,
    bestSeller: false,
    lowStock: false,
    available: true,
    tags: ['cuernos', 'demonio', 'diadema', 'halloween', 'accesorio'],
    season: 'halloween',
    seoTitle: 'Diadema Cuernos de Demonio — Accesorios Halloween Mérida | Maskaritas',
    seoDescription: 'Diadema con cuernos texturizados, ideal para disfraces de demonio o criatura. Entregas en Mérida, Yucatán.',
  },
  {
    id: 'prod-003',
    slug: 'mascara-veneciana-verde',
    sku: 'MSK-2026-103',
    name: 'Máscara Veneciana Nariz Larga — Verde',
    shortName: 'Máscara Veneciana Verde',
    category: 'accesorios',
    subcategory: 'mascaras',
    collection: '',
    audience: 'adultos',
    description: 'Máscara veneciana de nariz larga (estilo "zanni"), blanca con degradado verde y detalles dorados pintados a mano.',
    contents: ['1 máscara'],
    price: 250,
    compareAtPrice: null,
    sizes: ['Única'],
    sizeInventory: { Única: 4 },
    colors: ['Blanco / Verde'],
    images: ['/images/products/mascara-veneciana-verde-01.jpg'],
    featured: false,
    newArrival: true,
    bestSeller: false,
    lowStock: false,
    available: true,
    tags: ['máscara', 'veneciana', 'carnaval', 'accesorio'],
    season: '',
    seoTitle: 'Máscara Veneciana Verde — Accesorios Mérida | Maskaritas',
    seoDescription: 'Máscara veneciana de nariz larga con detalles dorados. Entregas en Mérida, Yucatán.',
  },
  {
    id: 'prod-004',
    slug: 'diadema-arana-negra',
    sku: 'MSK-2026-104',
    name: 'Diadema Araña Negra',
    shortName: 'Diadema Araña',
    category: 'accesorios',
    subcategory: 'diademas',
    collection: 'halloween',
    audience: 'adultos',
    description: 'Diadema con araña texturizada de ojos rojos y velo de tul negro. Un toque dramático y elegante para la noche de Halloween.',
    contents: ['1 diadema'],
    price: 250,
    compareAtPrice: null,
    sizes: ['Única'],
    sizeInventory: { Única: 5 },
    colors: ['Negro'],
    images: ['/images/products/diadema-arana-negra-01.jpg'],
    featured: true,
    newArrival: true,
    bestSeller: false,
    lowStock: false,
    available: true,
    tags: ['araña', 'diadema', 'halloween', 'accesorio'],
    season: 'halloween',
    seoTitle: 'Diadema Araña Negra — Accesorios Halloween Mérida | Maskaritas',
    seoDescription: 'Diadema con araña y velo de tul negro, ideal para Halloween. Entregas en Mérida, Yucatán.',
  },
  {
    id: 'prod-005',
    slug: 'mano-hombre-lobo-cafe',
    sku: 'MSK-2026-105',
    name: 'Mano Hombre Lobo — Café',
    shortName: 'Mano Hombre Lobo Café',
    category: 'accesorios',
    subcategory: 'manos',
    collection: 'halloween',
    audience: 'adultos',
    description: 'Guante de mano peluda con garras, para completar un disfraz de hombre lobo o criatura. Acabado realista.',
    contents: ['1 par de manos'],
    price: 250,
    compareAtPrice: null,
    sizes: ['Única'],
    sizeInventory: { Única: 4 },
    colors: ['Café'],
    images: ['/images/products/mano-hombre-lobo-cafe-01.jpg'],
    featured: false,
    newArrival: true,
    bestSeller: false,
    lowStock: false,
    available: true,
    tags: ['hombre lobo', 'manos', 'garras', 'halloween', 'accesorio'],
    season: 'halloween',
    seoTitle: 'Mano Hombre Lobo Café — Accesorios Halloween Mérida | Maskaritas',
    seoDescription: 'Guante de mano peluda con garras para disfraz de hombre lobo. Entregas en Mérida, Yucatán.',
  },
  {
    id: 'prod-006',
    slug: 'mano-hombre-lobo-negro',
    sku: 'MSK-2026-106',
    name: 'Mano Hombre Lobo — Negro',
    shortName: 'Mano Hombre Lobo Negro',
    category: 'accesorios',
    subcategory: 'manos',
    collection: 'halloween',
    audience: 'adultos',
    description: 'Guante de mano peluda con garras en tono negro, para completar un disfraz de hombre lobo o criatura oscura.',
    contents: ['1 par de manos'],
    price: 250,
    compareAtPrice: null,
    sizes: ['Única'],
    sizeInventory: { Única: 4 },
    colors: ['Negro'],
    images: ['/images/products/mano-hombre-lobo-negro-01.jpg'],
    featured: false,
    newArrival: true,
    bestSeller: false,
    lowStock: false,
    ...
    tags: ['hombre lobo', 'manos', 'garras', 'halloween', 'accesorio'],
    season: 'halloween',
    seoTitle: 'Mano Hombre Lobo Negro — Accesorios Halloween Mérida | Maskaritas',
    seoDescription: 'Guante de mano peluda con garras, tono negro, para disfraz de criatura. Entregas en Mérida, Yucatán.',
  },
  {
    id: 'prod-007',
    slug: 'mascara-oso-siniestro',
    sku: 'MSK-2026-107',
    name: 'Máscara Oso Siniestro',
    shortName: 'Máscara Oso Siniestro',
    category: 'accesorios',
    subcategory: 'mascaras',
    collection: 'halloween',
    audience: 'adultos',
    description: 'Máscara de peluche desgastado con sonrisa filosa, para un disfraz de terror con un giro nostálgico e inquietante.',
    contents: ['1 máscara'],
    price: 250,
    compareAtPrice: null,
    sizes: ['Única'],
    sizeInventory: { Única: 3 },
    colors: ['Café claro'],
    images: ['/images/products/mascara-oso-siniestro-01.jpg'],
    featured: true,
    newArrival: true,
    bestSeller: false,
    lowStock: false,
    available: true,
    tags: ['máscara', 'oso', 'terror', 'halloween', 'accesorio'],
    season: 'halloween',
    seoTitle: 'Máscara Oso Siniestro — Accesorios Halloween Mérida | Maskaritas',
    seoDescription: 'Máscara de oso de peluche con sonrisa filosa, disfraz de terror. Entregas en Mérida, Yucatán.',
  },
  {
    id: 'prod-008',
    slug: 'mascara-veneciana-roja',
    sku: 'MSK-2026-108',
    name: 'Máscara Veneciana Nariz Larga — Roja',
    shortName: 'Máscara Veneciana Roja',
    category: 'accesorios',
    subcategory: 'mascaras',
    collection: '',
    audience: 'adultos',
    description: 'Máscara veneciana de nariz larga (estilo "zanni"), blanca con degradado rojo y detalles dorados pintados a mano.',
    contents: ['1 máscara'],
    price: 250,
    compareAtPrice: null,
    sizes: ['Única'],
    sizeInventory: { Única: 4 },
    colors: ['Blanco / Rojo'],
    images: ['/images/products/mascara-veneciana-roja-01.jpg'],
    featured: false,
    newArrival: true,
    bestSeller: false,
    lowStock: false,
    ...
    tags: ['máscara', 'veneciana', 'carnaval', 'accesorio'],
    season: '',
    seoTitle: 'Máscara Veneciana Roja — Accesorios Mérida | Maskaritas',
    seoDescription: 'Máscara veneciana de nariz larga con detalles dorados. Entregas en Mérida, Yucatán.',
  },
  {
    id: 'prod-009',
    slug: 'mascara-monja-terror',
    sku: 'MSK-2026-109',
    name: 'Máscara Monja de Terror',
    shortName: 'Máscara Monja Terror',
    category: 'accesorios',
    subcategory: 'mascaras',
    collection: 'halloween',
    audience: 'adultos',
    description: 'Máscara de látex de monja siniestra con capucha integrada, para un disfraz de terror de alto impacto.',
    contents: ['1 máscara con capucha'],
    price: 250,
    compareAtPrice: null,
    sizes: ['Única'],
    sizeInventory: { Única: 3 },
    colors: ['Negro / Blanco'],
    images: ['/images/products/mascara-monja-terror-01.jpg'],
    featured: true,
    newArrival: true,
    bestSeller: false,
    lowStock: false,
    available: true,
    tags: ['máscara', 'monja', 'terror', 'halloween', 'accesorio'],
    season: 'halloween',
    seoTitle: 'Máscara Monja de Terror — Accesorios Halloween Mérida | Maskaritas',
    seoDescription: 'Máscara de monja siniestra con capucha, disfraz de terror de alto impacto. Entregas en Mérida, Yucatán.',
  },
];
